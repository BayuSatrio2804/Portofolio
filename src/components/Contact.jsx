...
function Contact() {
    ...
    return (
        <section id="contact" style={{ padding: '6rem 5% 6rem' }}>
            <div className="bento-grid" style={{ maxWidth: '950px', margin: '0 auto' }}>
                ...
                >
                    <h2 className="title-gradient" style={{ fontSize: '2.5rem', marginBottom: '1.5rem', textAlign: 'left' }}>Let's Connect!</h2>
                    <p style={{ color: '#94a3b8', lineHeight: 1.7, fontSize: '1.05rem', marginBottom: '2.5rem' }}>
                        Do you have an exciting project, an open position, or just want to chat about technology over a cup of coffee? Don't hesitate to send a message through this form!
                    </p>
                ...
                >
                    {isSent ? (
                        <div style={{ height: '100%', minHeight: '300px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
                            <h3 style={{ color: '#38bdf8', fontSize: '2.2rem', marginBottom: '1rem' }}>Message Sent! 🚀</h3>
                            <p style={{ color: '#94a3b8', lineHeight: 1.6 }}>Thank you for reaching out. I have received the notification and will respond to your email as soon as possible.</p>
                            <button onClick={() => setIsSent(false)} className="btn primary-btn" style={{ marginTop: '2.5rem', padding: '0.8rem 2rem' }}>Send Another Message</button>
                        </div>
                    ) : (
                        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                            ...
                            <input type="text" name="subject" placeholder="Subject / Purpose" required style={inputStyle} />

                            <textarea name="message" placeholder="Write your awesome message here..." rows="5" required style={{ ...inputStyle, resize: 'vertical' }}></textarea>
